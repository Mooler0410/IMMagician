...
sampleButtons = function()
{
	...
	exampleButtons.on("click", function() {
		...
		// updateCanvasSizeandStyle(image1);
...
UPLOADinit = function()
{
	...
	mouseXY[0] = [0.34, -0.0746];
	// image1.src = "images/Escher/handWithSphere/dark0.png"; //dark
	image1.src = "images/sea1.jpg";
	// image2.src = "images/Escher/handWithSphere/bright0.png"; //bright
	image2.src = "images/white.png"; //bright
	image3.src = "images/earthmap.png"; //shape map
	image4.src = "images/Escher/handWithSphere/reflect2.jpg";  //reflection
	image5.src = "images/env3.jpg";//refraction
	image6.src = "images/Escher/handWithSphere/alpha1.png";
...
function fileUploaded(event, elemName)
{
	...
	else if(elemName === "container3")
	{
		...
		normalWidth = image3.width;
		normalHeight = image3.height;
